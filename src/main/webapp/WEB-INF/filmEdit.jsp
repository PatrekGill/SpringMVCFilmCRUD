...
<body>
    <c:if test="${not empty newlyCreated }">
        <script>
            var message = "${error}";
            alert("Creation of Film Succeeded!");
        </script>
	</c:if>
    <div class="container">
        							...
        							<tr>
        								<td>
        									...
        									<div class="input-group">
        									    ...
        									    <textarea class="form-control" name="description" placeholder="Description"><c:out value = "${film.description}"/></textarea>
        								  	</div>
        								</td>
        							</tr>
        							...
        							<tr>
        								<td>
        									...
        									<div class="input-group">
        									    ...
        									    <input type="number" name="releaseYear" min="0" max="9999" step="1" value="${film.releaseYear}" class="form-control" placeholder="Release Year"/>
        								  	</div>
        								</td>
        							</tr>
        							...
        							<tr>
        								<td>
        									...
        									<div class="input-group">
        									    ...
        									    <input type="number" name="rentalDuration" min="0" max="255" step="1" value="${film.rentalDuration}" class="form-control" placeholder="Rental Duration (days)"/>
        								  	</div>
        								</td>
        							</tr>
        							...
        							<tr>
        								<td>
        									...
        									<div class="input-group">
        									    ...
        									    <input type="number" name="rentalRate" min="0" max="99.99" step="0.01" value="${film.rentalRate}" class="form-control" placeholder="Rental Rate (USD)"/>
        								  	</div>
        								</td>
        							</tr>
                                    ...
                                    <tr>
        								<td>
        									...
        									<div class="input-group">
        									    ...
        									    <input type="number" name="length" min="0" max="32767" step="1" value="${film.length}" class="form-control" placeholder="Film Length (minutes)"/>
        								  	</div>
        								</td>
        							</tr>
                                    ...
                                    <tr>
        								<td>
        									...
        									<div class="input-group">
        									    ...
        									    <input type="number" name="replacementCost" min="0" max="999.99" step="0.01" value="${film.replacementCost}" class="form-control" placeholder="Replacement Cost: (USD)"/>
        								  	</div>
        								</td>
        							</tr>
        								...
        								<td>
                                            <div>
                                                <button type="submit" class="btn btn-success">
                                                    <i class="glyphicon glyphicon-floppy-disk" style="font-size:22px; vertical-align: middle;"></i>
                                                    <span style="font-size:15px; vertical-align: middle;">Save Changes</span>
                                                </button>
                							</div>
